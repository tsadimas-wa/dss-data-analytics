...
models = [
    ('Random Forest',   0.92, '#1565C0', '-',  2.2),
    ('Logistic Reg.',   0.85, '#2E7D32', '--', 1.8),
    ('Decision Tree',   0.78, '#E65100', '-.',  1.6),
]
...
# Shaded AUC area for Random Forest
fpr_rf, tpr_rf = make_roc(0.92)
ax.fill_between(fpr_rf, tpr_rf, alpha=0.07, color='#1565C0')

ax.set_xlabel('False Positive Rate (FPR)\n← Λιγότεροι λάθος συναγερμοί', fontsize=10)
ax.set_ylabel('True Positive Rate (TPR = Recall)\n← Περισσότερες σωστές ανιχνεύσεις', fontsize=10)
ax.set_title('Καμπύλη ROC — Σύγκριση Μοντέλων', fontsize=12, fontweight='bold')
...
plt.tight_layout()
out = '/home/rg/Teaching/uniwa/dss-data-analytics/img/lec6/roc_curve.png'

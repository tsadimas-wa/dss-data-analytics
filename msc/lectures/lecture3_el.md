...
1.  **Ανασκόπηση από Ενότητα 2**
    ...
    -   **Τι είναι Μοντέλο Διεργασίας:** Mapping, Abstraction, 3 Βασικά Συστατικά
    -   **Σκοπός & Αποδέκτες:** Γιατί μοντελοποιούμε, Process Analyst vs Domain Expert
...
2.  **BPMN 2.0 — Εμβάθυνση**
    ...
    -   **Δεδομένα:** Data Objects, Data Stores, State of Data Objects, Data Association, Text Annotations
    -   **Message Flow & Pools/Lanes:** Επικοινωνία μεταξύ οργανισμών, Message Start Event
    -   **Μεθοδολογία Σχεδιασμού BPMN:** 4 Φάσεις, 5-βήματα Top-Down, Τεχνικές Συλλογής Πληροφοριών
...
# 1.2 Τι είναι ένα Μοντέλο Διεργασίας;
...
# 1.3 Σκοπός Μοντελοποίησης & Ενδιαφερόμενα Μέρη
...
# 2.9 Μεθοδολογία Σχεδιασμού Διεργασιών
...
# 2.9.1 Τεχνικές Συλλογής Πληροφοριών Διεργασίας

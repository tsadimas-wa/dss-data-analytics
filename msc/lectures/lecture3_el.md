...
> **Entry vs. Exit Criterion (Sentry):** Διακρίνουμε δύο τύπους Sentry: το **Entry Criterion** (◇ εισόδου) που **ξεκλειδώνει** ένα Task ή Stage για εκτέλεση, και το **Exit Criterion** (◇ εξόδου) που **κλείνει αναγκαστικά** ένα Stage όταν συμβεί κάποιο γεγονός, ακόμη και αν Tasks εντός του δεν έχουν ολοκληρωθεί.

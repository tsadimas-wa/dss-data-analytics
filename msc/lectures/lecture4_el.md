...
<!-- Ορισμός Big Data: Δεν είναι απλά "πολλά" δεδομένα. Είναι δεδομένα που σπάνε τα όρια των παραδοσιακών RDBMS. Αναφέρετε την εξέλιξη από Terabytes σε Zettabytes. Το "Big" είναι σχετικό: Για ένα συνοικιακό κατάστημα, 100GB ίσως είναι Big Data. Ερώτηση: Ποιες "άχρηστες" πηγές του παρελθόντος είναι σήμερα χρυσωρυχεία; (π.χ. Web logs, data από αισθητήρες/IoT, tweets). -->

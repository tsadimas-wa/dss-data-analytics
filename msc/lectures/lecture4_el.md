...
<!-- _class: xsmall -->
# 2.4 Βασικές Αρχές Big Data Analytics
...
<!-- _class: xsmall -->
# 2.5 Τεχνολογίες Big Data (Hadoop, Spark, NoSQL)
...
<!-- _class: small -->
# 2.6 Πώς λειτουργεί το MapReduce
...
<!-- _class: xsmall -->
# 2.6 Big Data & Stream Analytics (Ανάλυση Ροών)
...
<!-- _class: xsmall -->
# 3.1 Αποθήκες Δεδομένων (Data Warehouse)

Μια **Αποθήκη Δεδομένων (Data Warehouse - DW)** είναι μια ενοποιημένη συλλογή τρεχόντων και ιστορικών δεδομένων, σχεδιασμένη για να υποστηρίζει τη λήψη αποφάσεων. Σε αντίθεση με τα λειτουργικά συστήματα (π.χ. ERP) που είναι βελτιστοποιημένα για συναλλαγές, το DW είναι βελτιστοποιημένο για ανάλυση.
...
*   **Τύποι:**
    *   **Enterprise Data Warehouse (EDW):** Η κεντρική αποθήκη για ολόκληρο τον οργανισμό.
    *   **Data Marts (DM):** Μικρότερες, εστιασμένες αποθήκες για συγκεκριμένα τμήματα (π.χ. Marketing, Οικονομικά).
    *   **Operational Data Stores (ODS):** Ενδιάμεσος χώρος για την ενοποίηση δεδομένων πριν την είσοδο στο DW.
...
<!-- _class: xsmall -->
# 3.2 Αρχιτεκτονική DW: Τύποι & Μεταδεδομένα

<div class="columns">
<div>

**1. Enterprise Data Warehouse (EDW)**
Αποθήκη μεγάλης κλίμακας που εξυπηρετεί *ολόκληρο* τον οργανισμό. Ενοποιεί δεδομένα από πολλαπλές πηγές σε κοινό, τυποποιημένο πρότυπο, υποστηρίζοντας συστήματα CRM, SCM και ΒΡΜ.

**2. Data Marts (DM)**
Μικρότερο, εστιασμένο υποσύνολο που εξυπηρετεί ένα συγκεκριμένο τμήμα (π.χ. Marketing).
*   **Εξαρτημένο (Dependent):** Αντλεί δεδομένα *απευθείας* από το κεντρικό EDW. Εγγυάται ενιαίο μοντέλο δεδομένων και την ίδια "εκδοχή της αλήθειας" για όλους, αλλά απαιτεί την προ-ύπαρξη του EDW.
*   **Ανεξάρτητο (Independent):** Χαμηλότερου κόστους, αυτόνομη λύση. Αντλεί δεδομένα απευθείας από τις πηγές, παρακάμπτοντας το EDW (κατάλληλο για μικρότερες εταιρείες/τμήματα).

</div>
<div>

**3. Operational Data Store (ODS)**
Ενώ το DW είναι η "μακροπρόθεσμη μνήμη", το ODS λειτουργεί ως **"βραχυπρόθεσμη μνήμη"**.
*   Ενημερώνεται *συνεχώς* κατά την καθημερινή ροή εργασιών (δεν είναι στατικό).
*   Εξυπηρετεί άμεσες, λειτουργικές (mission-critical) αποφάσεις, προσφέροντας εικόνα σχεδόν σε πραγματικό χρόνο (near-real-time).
*   Χρησιμοποιείται συχνά ως ενδιάμεσος σταθμός (staging area) πριν τη φόρτωση στο DW.

**Μεταδεδομένα (Metadata)**
Τα "δεδομένα για τα δεδομένα". Περιγράφουν τη δομή, τη σύνταξη και τη σημασία της πληροφορίας (syntactic, structural, semantic). Χωρίζονται σε τεχνικά (technical) και επιχειρηματικά (business metadata) και είναι κρίσιμα για την ορθή κατανόηση της αποθήκης από τους χρήστες.
...
<!-- _class: xsmall -->
# 3.3 Η Διαδικασία Αποθήκευσης Δεδομένων (DW Process)

Η διαχείριση και χρήση δεδομένων από πολλαπλές πηγές είναι μια εξαιρετικά σύνθετη εργασία, η οποία όμως προσφέρει τεράστια οφέλη στη λήψη αποφάσεων. Η διαδικασία αποτελείται από τα εξής κύρια δομικά στοιχεία:
...
<!-- _class: small -->
# 3.4 Εννοιολογική Αρχιτεκτονική Αποθήκης Δεδομένων
*(A High-Level Conceptual Architecture)*
...
<!-- _class: xsmall -->
# 3.5 Αρχιτεκτονικές Αποθηκών Δεδομένων (DW Architectures)
...
<!-- _class: xsmall -->
# 3.6 Επιχειρηματικές Αναφορές (Business Reporting)
...
<!-- _class: xsmall -->
# 3.7 Κατηγορίες Επιχειρηματικών Αναφορών
...
<!-- _class: small -->
# 3.8 Ο Ρόλος των Αναφορών στη Λήψη Αποφάσεων
...
<!-- _class: xsmall -->
# 3.9 Οπτικοποίηση Δεδομένων (Data Visualization)
...
<!-- _class: xsmall -->
# 3.10 Η Ιστορική Εξέλιξη της Οπτικοποίησης
...
<!-- _class: xxsmall -->
# 3.12 Εξειδικευμένα Γραφήματα & Χάρτες
...
<!-- _class: xsmall -->
# 3.13 Ταξινομία Γραφημάτων: Ποιο να επιλέξω;
...
<!-- _class: xsmall -->
# 1. Τι είναι η Εξόρυξη Δεδομένων (Data Mining);
...
<!-- _class: xsmall -->
# 3. Εναλλακτικές Μεθοδολογίες: KDD & SEMMA
...
<!-- _class: small -->
# 4. Βασικές Μέθοδοι (Εργασίες) Εξόρυξης Δεδομένων
...
<!-- _class: xsmall -->
# 5. Πρακτικές Εφαρμογές στην Αγορά
...
# Η Σύγκλιση: AI, Data Science & Process Automation

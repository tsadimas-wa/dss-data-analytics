...
<!-- _class: xsmall -->
# 3.5 Προβλεπτική Αναλυτική II: Εξόρυξη Κειμένου (Text Mining)
...
# 3.5α Η Διαδικασία της Εξόρυξης Κειμένου (Text Analytics Process)
...
<!-- _class: xsmall -->
# 3.5.1 Επεξεργασία Φυσικής Γλώσσας (NLP)
...
<!-- _class: xsmall -->
# 3.5.2 Η Διαδικασία του Text Mining στην Πράξη
...
<!-- _class: xsmall -->
# 3.6 Βαθιά Μάθηση (Deep Learning)
...
![](../img/lec4/deep-learning-venn.png)

---

<!-- _class: xsmall -->
# 3.6.1 Εφαρμογές και Περιορισμοί του Deep Learning
...
<!-- _class: small -->
# 3.6.2 Γνωστική Υπολογιστική (Cognitive Computing)

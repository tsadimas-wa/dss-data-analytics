...
<!-- Τονίστε: η ποιότητα δεδομένων είναι ο #1 παράγοντας αποτυχίας σε έργα BI. GIGO: Garbage In, Garbage Out. Ποια μετρική ποιότητας θεωρούν πιο σημαντική για ένα e-shop; -->
...
<!-- Κρίσιμο: ο τύπος δεδομένων καθορίζει τον αλγόριθμο. Παράδειγμα One-Hot Encoding: Φύλο (Αρσενικό=[1,0], Θηλυκό=[0,1]). Ερώτηση: σε ποια κατηγορία ανήκει ο ταχυδρομικός κώδικας; -->
...
<!-- Το 80% του χρόνου σε έργα Data Mining πηγαίνει στα βήματα 1-3! Παράδειγμα: πώς αντιμετωπίζουμε missing values σε ιατρικό dataset — imputation vs. deletion; -->
...
<!-- Τονίστε τον σχετικό ορισμό: Big Data για μια ΜΜΕ ≠ Big Data για το Google. Ερώτηση: ποιες πηγές Big Data μπορεί να έχει ένα νοσοκομείο που παλαιότερα αγνοούσε; -->
...
<!-- Hadoop vs. Spark: η αναλογία — Hadoop=αρχειοθήκη σε δίσκο, Spark=RAM. NoSQL παράδειγμα: MongoDB για προφίλ χρηστών. Ερώτηση: πότε θα χρησιμοποιούσατε NoSQL αντί για RDBMS; -->
...
<!-- Χρησιμοποιήστε το κλασικό παράδειγμα 'word count' για το MapReduce. Δείξτε πώς τεμαχίζεται ένα μεγάλο αρχείο κειμένου σε πολλούς κόμβους και γιατί η παράλληλη επεξεργασία είναι τόσο γρήγορη. -->
...
<!-- Ζητήστε 1 παράδειγμα από κάθε τύπο αναλυτικής από τους φοιτητές. Τονίστε ότι το Prescriptive στηρίζεται πάνω στο Predictive. Χρησιμοποιήστε τη τριγωνική ταξινόμηση ως προγρεσσική αξία ερωτήσεων. -->
...
<!-- Ο κύκλος data→report→decision→action είναι θεμελιακός. Ερώτηση: τι γίνεται αν οι αναφορές φτάνουν με 2 μήνες καθυστέρηση; Συνδέστε με Business Process Management. -->
...
<!-- Ερώτηση 'τι θέλω να δείξω;' πριν επιλογή. Δείξτε chart chooser του Abela. Κοινό λάθος: 3D pie chart — αδύνατο να διαβαστεί σωστά. -->
...
<!-- SQL='φέρε πελάτες >σ50 ετών', DM='ποιοι θα αγοράσουν ξανά'; Αυτή η διαφορά είναι η ουσία. Παράδειγμα: Market Basket Analysis στο supermarket. -->
...
<!-- Text Mining γεφυρώνει χάσμα: ελεύθερο κείμενο → αναλύσιμα δεδομένα για αλγόριθμους DM. Παράδειγμα: social media sentiment για brand monitoring. -->
...
<!-- Αναλογία: ML=cooking με recipe, DL=cooking by tasting. 3 παράγοντες: Big Data, GPUs, αλγόριθμοι. Ερώτηση: τι είναι "feature" σε ML; -->
...
<!-- IBM Watson: δεν αντικαθιστά τον γιατρό — τον ενισχύει. Augmentation vs. Automation: κρίσιμη διάκριση. Ερώτηση: πού αρέσκει να βλέπουμε AI να αποφασίζει αυτόνόμα και πού όχι; -->
...
<!-- Βεβαιότητα→LP, Κίνδυνος→Expected Value, Αβεβαιότητα→Simulation. Πότε χρησιμοποιούμε το καθένα; Παράδειγμα: απόφαση επένδυσης υπό αβεβαιότητα vs. γνωστές πιθανότητες. -->
...
<!-- Netflix: Predictive → Prescriptive → Automated σε milliseconds. Ολόκληρος ο κύκλος. Ερώτηση: πώς γνωρίζει το Netflix τι να σου προτείνει; -->
...
<!-- Digital Twin αεροκινητήρα: κάθε κινητήρας έχει ψηφιακό δίδυμο. AI Agents = από 'συμβουλεύει' σε 'δρα'. Ερώτηση: εμπιστεύεστε ένα AI Agent να αναθέσει αυτόνομα πόρους; -->

...
<!-- Ερώτηση προς τους φοιτητές: Γιατί δεν τρέχουμε τις αναλύσεις μας απευθείας πάνω στην επιχειρησιακή βάση (OLTP π.χ. στο ERP μας); Απάντηση: Γιατί τα πολύπλοκα ερωτήματα θα "γονάτιζαν" το σύστημα και θα καθυστερούσαν τις καθημερινές συναλλαγές. Το DW (OLAP) είναι δομημένο αποκλειστικά για γρήγορη ανάγνωση και ανάλυση μεγάλου όγκου δεδομένων, διατηρώντας το ιστορικό (time-variant) ακόμα κι αν τα δεδομένα διαγραφούν από το ERP. -->

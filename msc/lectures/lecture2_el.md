...
| Εργαλείο | Ρόλος | Λειτουργία |
|---|---|---|
| **Camunda Modeler** | Μοντελοποίηση | Σχεδιασμός BPMN → αποθήκευση σε `.bpmn` (XML) |
| **Spring Boot App** | Μηχανή Εκτέλεσης | Φορτώνει το `.bpmn` και "ζωντανεύει" τη διεργασία |
| **Java Workers** | Πάροχοι Πόρων | Υλοποιούν τη λογική των Service Tasks |
...
![w:380](../img/lecture2/diag_camunda_flow.svg)

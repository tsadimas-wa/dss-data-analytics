...
![w:1000](../img/lecture2/diag_process_map.png)
...
# Case Study: DevOps στην Ανάπτυξη Λογισμικού
...
# DevOps: Agile Μεθοδολογίες & Συνεχής Βελτίωση
...
# DevOps: CI/CD Pipelines — Ο Αυτοματισμός της Παράδοσης
...
# DevOps: Μείωση Lead Time στην Ανάπτυξη Λογισμικού
...
# Συμπέρασμα: DevOps & Διοίκηση Λειτουργιών
...
# KPIs Χρόνου: Lead Time & Cycle Time
...
# KPIs Χρόνου: Takt Time — Ο Μετρονόμος του Sprint
...
![w:800](../img/lecture2/diag_process_arch.png)

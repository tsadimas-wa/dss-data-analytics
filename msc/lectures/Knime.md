...
Για αυτό το πρακτικό παράδειγμα, μπορείτε να κατεβάσετε ένα γνωστό dataset από το Kaggle (π.χ. το **Superstore Sales Dataset**). Στόχος μας είναι να διαβάσουμε τα δεδομένα πωλήσεων, να φιλτράρουμε μια συγκεκριμένη κατηγορία, να υπολογίσουμε τα έσοδα και να τα οπτικοποιήσουμε.

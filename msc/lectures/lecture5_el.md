...
math: katex
html: true
header: 'Ενότητα 5: Ψηφιακός Μετασχηματισμός: Τεχνολογίες, Αρχιτεκτονική & Ασφάλεια'
...
**Ενότητα 5: Ψηφιακός Μετασχηματισμός: Τεχνολογίες, Αρχιτεκτονική & Ασφάλεια**
...
🎤 **Ερώτηση αλληλεπίδρασης:** "Αν ήσασταν ο δήμαρχος της πόλης σας και είχατε αύριο το πρωί ένα τέτοιο ψηφιακό δίδυμο στα χέρια σας, ποιο είναι το πρώτο πρόβλημα που θα προσπαθούσατε να λύσετε;"
*(Αναμενόμενες απαντήσεις: Κυκλοφοριακό, πρόληψη πλημμυρών, ενεργειακή διαχείριση δημοτικών κτιρίων).*
-->
...
🎤 **Ερώτηση προς την τάξη:** "Πόσοι από εσάς έχετε χρειαστεί να ανοίξετε λογαριασμό σε νέα τράπεζα ή να επικαιροποιήσετε τα στοιχεία σας; Πόσο χρόνο σας πήρε η γραφειοκρατία; Φανταστείτε όλο αυτό να γίνεται σε δευτερόλεπτα με ένα κλικ."
-->
...
💡 **Σημείο Έμφασης:** Το DLT εδώ δεν έχει καμία σχέση με κρυπτονομίσματα. Είναι αποκλειστικά "τεχνολογία εμπιστοσύνης" μεταξύ ανταγωνιστών (τραπεζών).
-->
...
🎤 **Ερώτηση αλληλεπίδρασης:** "Φανταστείτε ότι είστε υπάλληλος που η δουλειά σας είναι να κάνετε copy-paste 500 εγγραφές τη μέρα. Αν ένα RPA bot πάρει αυτή τη δουλειά, νιώθετε απειλή ή απελευθέρωση; (Ο στόχος του Hyperautomation είναι να απελευθερώσει τον άνθρωπο για δημιουργική εργασία, όχι απλώς να μειώσει το headcount)."
-->
...
🎤 **Ερώτηση προς την τάξη:** "Έχετε μπει ποτέ σε e-shop όπου μπορούσατε να δείτε τα προϊόντα, αλλά το καλάθι αγορών έβγαζε σφάλμα; Αυτό είναι ένα τέλειο παράδειγμα όπου το service του καταλόγου δουλεύει, ενώ το service του checkout (ή των πληρωμών) έχει καταρρεύσει."
-->
...
🎤 **Ερώτηση αλληλεπίδρασης:** "Αν αύριο αποχωρήσει ένας senior developer από την εταιρεία σας, είστε 100% σίγουροι ότι έχει κοπεί η πρόσβασή του σε *όλες* τις βάσεις δεδομένων; Το CyberArk διασφαλίζει ακριβώς ότι κανείς δεν έχει "μόνιμα" κλειδιά (Zero Standing Privileges)."
-->
...
🎤 **Δίλημμα για την τάξη:** "Ένας developer γράφει έναν τέλειο, αλάνθαστο κώδικα, αλλά η εκτέλεσή του κοστίζει 5.000€ το μήνα στο AWS. Είναι καλός κώδικας; Το FinOps αλλάζει τη νοοτροπία: ο κώδικας πρέπει να είναι και οικονομικά αποδοτικός."
-->
...
🎤 **Ερώτηση προς την τάξη:** "Γιατί νομίζετε ότι η τράπεζα χρειάστηκε «agile squads» αποκλειστικά για τα APIs και δεν τα άφησε στο κλασικό ΙΤ τμήμα;" 
*(Απάντηση: Διότι τα APIs πλέον δεν θεωρούνται απλά τεχνικά "καλώδια" αλλά ολοκληρωμένα **προϊόντα** που χρειάζονται συνεχή υποστήριξη και εξέλιξη).*
-->
...
🎤 **Ερώτηση αλληλεπίδρασης:** "Έχετε λάβει ποτέ ύποπτο SMS που λέει ότι το πακέτο σας μπλόκαρε στο τελωνείο, ακριβώς τη μέρα που περιμένατε δέμα; Αυτό ονομάζεται *Smishing* (SMS Phishing) και βασίζεται στην καθαρή σύμπτωση και την αίσθηση επείγοντος."
-->
...
🎤 **Poll στην τάξη:** "Πόσοι από εσάς χρησιμοποιείτε Password Manager (π.χ. Bitwarden, 1Password); Πόσοι χρησιμοποιείτε ακόμα το μυαλό σας για να θυμάστε κωδικούς; Ο ανθρώπινος εγκέφαλος δεν φτιάχτηκε για να θυμάται 50 διαφορετικούς κρυπτογραφικούς κωδικούς. Χρησιμοποιήστε εργαλεία!"
-->
...
🎤 **Ερώτηση προς την τάξη:** "Αν μια εταιρεία έχει πιστοποίηση ISO 27001, σημαίνει ότι δεν θα παραβιαστεί ποτέ; (Η απάντηση είναι ΌΧΙ. Σημαίνει ωστόσο ότι αν παραβιαστεί, μπορεί να αποδείξει νομικά ότι είχε λάβει όλα τα 'εύλογα' μέτρα προστασίας, γλιτώνοντας νομικές κυρώσεις και δυσβάσταχτα πρόστιμα)."
-->

...
```
     ...
     Marketing  Finance  Operations  HR
        |                  |
    Digital  Brand    Παραγωγή  Logistics
```
...
```
  ...
  (Smartphones) (Laptops)   (Cloud)
   Mktg|Ops|HR  Mktg|Ops|HR  Mktg|Ops|HR
```
...
```
         ...
         _____|_____
        |            |
   Λειτ. Δ/ντές    Project Managers
   (Finance, IT…)  (Project A, B, C)
        |            |
        └────┬────────┘
         Εργαζόμενοι
         (διπλή αναφορά)

...
ax.set_xlabel('Ισχύς Κλιματιστικού P (%)', fontsize=12)
ax.set_ylabel('fire strength (βάρος)', fontsize=12)
ax.set_title('Defuzzification — Centroid (σταθμισμένος μέσος)', fontsize=13, fontweight='bold')
...
active = mpatches.Patch(color='#FF9800', label='Ενεργός κανόνας (fire > 0)')
inactive = mpatches.Patch(color='#9E9E9E', alpha=0.4, label='Ανενεργός κανόνας (fire = 0)')

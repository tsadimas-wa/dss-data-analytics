...
> **Deep Learning:** μαθαίνει μόνο του **ποια χαρακτηριστικά** έχουν σημασία — δεν χρειάζεται χειροκίνητη επιλογή.
...
* $\eta$: **learning rate** — πόσο μεγάλο βήμα κάνουμε
* Μικρό $\eta$ → αργή σύγκλιση
* Μεγάλο $\eta$ → αστάθεια, παράκαμψη ελαχίστου
...
* **Q** (Query): «τι ψάχνω;»
* **K** (Key): «τι προσφέρω;»
* **V** (Value): «ποια πληροφορία μεταδίδω;»
...
* $\phi_0$: βασική πρόβλεψη (μέση τιμή)
...
> **SHAP vs LIME:** Το SHAP έχει ισχυρότερες θεωρητικές εγγυήσεις (αξιώματα δικαιοσύνης), αλλά είναι υπολογιστικά πιο βαρύ.

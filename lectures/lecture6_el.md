...
Φανταστείτε να περιηγείστε σε έναν **λαβύρινθο**: με κάθε βήμα αντιμετωπίζετε μια απόφαση που σας οδηγεί πιο κοντά στην έξοδο ή πιο βαθιά μέσα. Αυτό μοιάζει με έναν **αλγόριθμο δέντρου αποφάσεων** — μια ισχυρή και διαισθητική μέθοδο μηχανικής μάθησης που βοηθά να κατανοήσουμε πολύπλοκα δεδομένα και να επιλέξουμε την καλύτερη πορεία δράσης.

Ένας αλγόριθμος δέντρου αποφάσεων αναλύει ένα σύνολο δεδομένων σε όλο και **μικρότερα υποσύνολα** με βάση ορισμένες συνθήκες. Ξεκινά με έναν μόνο **κόμβο ρίζας** και επεκτείνεται σε πολλαπλούς **κλάδους** — καθένας αντιπροσωπεύει μια απόφαση βασισμένη στην τιμή ενός χαρακτηριστικού. Τα τελικά **φύλλα** του δέντρου είναι τα πιθανά αποτελέσματα ή προβλέψεις.

---

# Εποπτευόμενη Μάθηση: Δέντρα Απόφασης — Ορισμός
<!-- _class: small -->

Ένα Δέντρο Απόφασης κάνει διαδοχικές ερωτήσεις μέχρι να φτάσει σε μια απάντηση. Κάθε ερώτηση μπορεί να έχει δύο απαντήσεις (**ΝΑΙ/ΟΧΙ** για δυαδικές διασπάσεις) ή περισσότερες (για κατηγορικές μεταβλητές με πολλές τιμές).

...
Ένα **Δέντρο Απόφασης** κάνει διαδοχικές ερωτήσεις (ΝΑΙ/ΌΧΙ) μέχρι να φτάσει σε μια πρόβλεψη — ακολουθείτε τους κλάδους από τη ρίζα μέχρι ένα φύλλο.
...
| ΌΧΙ | C002✓ C004✓ C006✗ C007✗ C008✓ → 2Ν/3Ό | $0{,}48$ |
...
| ΌΧΙ | C005✗ C002✓ C004✓ C008✓ → 1Ν/3Ό | $0{,}375$ |
...
| ΌΧΙ | C002✓ C004✓ C008✓ → 0Ναι, 3Όχι | $0{,}00$ |

**Gini Gain = 0,375** → Τέλειο split!
🔴 **ΝΑΙ: ΑΚΥΡΩΣΗ** · 🟢 **ΌΧΙ: ΠΑΡΑΜΟΝΗ**
...
1. **[1] MonthlyCharges > 70€;** → 55 ≤ 70 → **ΌΧΙ** *(φτηνό πακέτο)*
...
Οι τιμές μετρούνται σε **bits** — επειδή χρησιμοποιούμε $\log_2$ (βάση 2 → bits). 1 bit = η πληροφορία μιας ερώτησης ΝΑΙ/ΌΧΙ. Το **Gini δεν έχει μονάδα** (είναι πιθανότητα, 0–0.5).

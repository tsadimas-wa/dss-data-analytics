...
<img src="humidity_fuzzification.png" alt="Fuzzification Υγρασίας H=72%" width="70%">
...
<div align="center">
<img src="defuzzification.png" alt="Fuzzification Υγρασίας H=72%"  width="70%">
</div>
...
![Mamdani vs Singleton](mamdani_vs_singleton.png)
...
|---|---|---|
| **Έξοδος κανόνα** | Ασαφής συνάρτηση (σχήμα) | Σημείο (singleton) |
...
| 3 | **Fuzzification** | Σαφείς τιμές → βαθμοί συμμετοχής | μ_Ζεστή=1.0, μ_Υψηλή=0.60 |

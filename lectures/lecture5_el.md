...
Επίσημα, μια γλωσσική μεταβλητή ορίζεται από 4 συστατικά: το όνομά της (π.χ. "Θερμοκρασία"), το σύμπαν ορισμού (π.χ. [0°C, 100°C]), το σύνολο των γλωσσικών τιμών/όρων (π.χ. {Κρύα, Χλιαρή, Ζεστή, Καυτή}), και τη συνάρτηση συμμετοχής για κάθε τιμή.
...
**Παράδειγμα — Γλωσσική μεταβλητή: «Τιμή Προϊόντος»**

| Τιμή (€) | Χαμηλή | Μέτρια | Υψηλή |
|---|---|---|---|
| 10 | 1.0 | 0.0 | 0.0 |
| 30 | 0.5 | 0.5 | 0.0 |
| 50 | 0.0 | 1.0 | 0.0 |
...
**Παράδειγμα — Γλωσσική μεταβλητή: «Επίπεδο Ρίσκου»**
* Τιμές: {Χαμηλό, Μέτριο, Υψηλό, Πολύ Υψηλό}
* Κάθε τιμή ορίζεται από ξεχωριστή συνάρτηση συμμετοχής.

> Οι γλωσσικές μεταβλητές επιτρέπουν στο σύστημα να επικοινωνεί με τους ανθρώπους στη **δική τους γλώσσα**.

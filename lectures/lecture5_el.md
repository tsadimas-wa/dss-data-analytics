...
Καλωσορίσατε στην 5η ενότητα. Εδώ κάνουμε τη μετάβαση από την "απόλυτη" βεβαιότητα της κλασικής λογικής στον πραγματικό κόσμο, όπου τα δεδομένα είναι ελλιπή, ασαφή ή στοχαστικά.
💡 **Στόχος:** Να κατανοήσουν οι φοιτητές ότι οι επιχειρηματικές αποφάσεις σπάνια είναι άσπρο-μαύρο. Το 99% λαμβάνονται υπό συνθήκες αβεβαιότητας.
-->

<!--
🗣️ **Παράδειγμα:** Φανταστείτε τον προγραμματισμό ενός αυτόνομου οχήματος. Αν η λογική του ήταν δυαδική (φρένο στο 1 μέτρο, γκάζι στα 1.01 μέτρα), η οδήγηση θα ήταν απότομη και επικίνδυνη. Η πραγματικότητα χρειάζεται "αποχρώσεις" (ασαφής λογική).
-->

<!--
🗣️ **Ιστορικό:** Ο Lotfi Zadeh αντιμετώπισε τεράστια πολεμική όταν πρότεινε την Ασαφή Λογική το '65. Οι παραδοσιακοί δυτικοί μαθηματικοί την απέρριπταν ως "αντιεπιστημονική". Αντίθετα, οι Ιάπωνες την αγκάλιασαν αμέσως. Σήμερα, βρίσκεται παντού: από τα έξυπνα πλυντήρια ρούχων μέχρι τα συστήματα ελέγχου τρένων.
-->

<!--
💡 **Σημείο προσοχής:** Τονίστε στους φοιτητές τη διαφορά του min/max από τον κλασικό πολλαπλασιασμό/άθροισμα των πιθανοτήτων. Στην ασαφή λογική (Mamdani), το min (AND) σημαίνει ότι ο κανόνας είναι ακριβώς τόσο ισχυρός όσο ο "πιο αδύναμος κρίκος" του.
-->

<!--
🤖 **Σύγχρονη Τάση (Neuro-Fuzzy):** Μπορεί η ασαφής λογική να φαίνεται "χειροκίνητη", αλλά σήμερα σπάνια γράφουμε τους κανόνες (MFs) με το χέρι. Χρησιμοποιούμε νευρωνικά δίκτυα για να "μάθουν" και να παραμετροποιήσουν τις συναρτήσεις συμμετοχής κατευθείαν από τα δεδομένα (όπως στο ANFIS), κρατώντας όμως τους κανόνες ερμηνεύσιμους (white-box).
-->

<!--
🗣️ **Βασικό Μήνυμα:** Το θεώρημα του Bayes είναι ίσως ο πιο σημαντικός μαθηματικός τύπος στην Τεχνητή Νοημοσύνη. 
💡 **Prior (P(A)):** Δώστε μεγάλη έμφαση στο Prior. Οι άνθρωποι (ακόμα και οι γιατροί!) κάνουν συχνά το λεγόμενο "Base Rate Fallacy", αγνοώντας το πόσο σπάνια είναι μια κατάσταση στον γενικό πληθυσμό.
-->

<!--
🎤 **Διαδραστικότητα:** Πριν αποκαλύψετε το αποτέλεσμα 16,1%, ρωτήστε την τάξη: "Αν το τεστ έχει 95% ακρίβεια και βγει θετικό, ποια είναι η πιθανότητα να είστε άρρωστος;". Η πλειοψηφία θα απαντήσει "95%". 
Η ανθρώπινη διαίσθηση (intuition) είναι φριχτή στις πιθανότητες. Αυτό το παράδειγμα αποδεικνύει γιατί τα Συστήματα Υποστήριξης Αποφάσεων (DSS) είναι απολύτως απαραίτητα!
-->

<!--
🗣️ **Judea Pearl (Turing Award):** Αναφέρετε τον δημιουργό τους. Ο Pearl έδειξε πώς μπορούμε να μοντελοποιήσουμε την *αιτιότητα* (causality) και όχι απλώς τη στατιστική συσχέτιση (correlation). Όπως λέει: "Το κοκοράκι λαλεί όταν βγαίνει ο ήλιος, αλλά αν σφάξουμε το κοκοράκι, ο ήλιος θα βγει ούτως ή άλλως". Τα Bayesian Networks ξεχωρίζουν αιτία από αποτέλεσμα.
-->

<!--
💡 **Predictive vs Diagnostic:** 
Predictive (Top-Down): Βλέπω μαύρα σύννεφα (αιτία), προβλέπω βροχή (αποτέλεσμα).
Diagnostic (Bottom-Up): Βλέπω βρεγμένο δρόμο (αποτέλεσμα), συμπεραίνω ότι έβρεξε (αιτία).
Τα Μπαϋεσιανά Δίκτυα είναι από τα ελάχιστα μοντέλα στην ΑΙ που μπορούν να κάνουν και τα δύο (inference in both directions) εξίσου κομψά.
-->

<!--
🗣️ **Σύνδεση με ΣΥΑ (DSS):** Εδώ ακριβώς χτυπάει η καρδιά των Συστημάτων Υποστήριξης Αποφάσεων. Το δίκτυο Bayes από μόνο του λέει απλά "τι θα γίνει" (πιθανότητα). Ο manager όμως ρωτάει "τι να κάνω;". Βάζοντας Utility (πόσο κοστίζει/ωφελεί) και Decision nodes, το μοντέλο παίρνει πλέον την τελική ΑΠΟΦΑΣΗ.
-->

<!--
🤖 **Generative AI Connection:** 
Μια εξαιρετική λεπτομέρεια για προχωρημένους: Ο Naive Bayes είναι ένα "Generative" (παραγωγικό) μοντέλο! Προσπαθεί να μάθει πώς "παράγονται" τα δεδομένα για κάθε κλάση (π.χ. τι λέξεις χρησιμοποιούν τα spam), σε αντίθεση με discriminative μοντέλα (όπως το Logistic Regression) που απλώς τραβάνε μια μαθηματική γραμμή διαχωρισμού. Είναι ένας από τους "προγόνους" της σημερινής Generative AI.
-->
...
$fire_i = min( μ_{temp_term(T),} μ_{hum_term(H)} )$
...
| **Mean of Maximum (MoM)** | Βρες το **μέγιστο ύψος μ** της αθροισμένης περιοχής (εδώ μ=0.60 του «Πλήρες»). Εντόπισε **όλα τα x** που το φτάνουν (x∈[90,100]). Πάρε τον **μέσο** τους. | (90+100)/2 = **95%** |
| **Largest of Maximum (LoM)** | Ίδιο βήμα εντοπισμού x. Από αυτό το σύνολο επίλεξε το **μεγαλύτερο x**. | max{90…100} = **100%** |

**Γιατί x∈[90,100] για το μέγιστο μ=0.60;**
Στο Mamdani, το «Πλήρες» έχει τραπεζοειδή MF με επίπεδη κορυφή στο [90,100]. Ο R7 έχει fire=0.60, άρα η MF αποκόπτεται οριζόντια στο 0.60 — **η κορυφή καλύπτει ολόκληρο το [90,100]**. Όλα τα x εκεί έχουν μ=0.60, που είναι το μέγιστο. Το «Δυνατό» (R6, fire=0.15) δεν φτάνει αυτό το ύψος → **αγνοείται** από MoM/LoM.

> **Centroid:** αντανακλά όλους τους κανόνες — η πιο διαδεδομένη επιλογή.
> **MoM:** «κεντράρει» μεταξύ των ακραίων x — ισορροπημένη απόφαση μέσα στην κυρίαρχη ζώνη.
> **LoM:** επιλέγει το ακραίο δεξί x — πιο «επιθετική» απόφαση, χρήσιμη σε worst-case σενάρια.
...
<!-- _class: xxsmall -->
# Πώς υπολογίζεται το P(A) = 0.0025

Το P(A) είναι η **ολική πιθανότητα** να χτυπήσει ο συναγερμός οποιαδήποτε μέρα — από οποιαδήποτε αιτία. Αθροίζουμε και τους **4 δυνατούς συνδυασμούς** αιτιών (B = Διάρρηξη, E = Σεισμός), πολλαπλασιάζοντας κάθε φορά την πιθανότητα να χτυπήσει *αν* βρισκόμαστε σε αυτό το σενάριο, επί την πιθανότητα να συμβεί αυτό το σενάριο:

$$P(A) = \sum_{b,\,e} P(A \mid b, e)\cdot P(b)\cdot P(e)$$

**Πώς διαβάζεται κάθε γραμμή:**

* **P(A|b,e):** από τον CPT πίνακα (Βήμα 2) — πόσο πιθανό είναι ο συναγερμός να χτυπήσει *αν* ισχύει αυτός ο συνδυασμός.
* **P(b):** η prior πιθανότητα Διάρρηξης (Β=Τ: 0.001, B=F: 1−0.001=0.999).
* **P(e):** η prior πιθανότητα Σεισμού (E=T: 0.002, E=F: 1−0.002=0.998).
* **Συνεισφορά = P(A|b,e) × P(b) × P(e)**

| Σενάριο | P(A\|b,e) | P(b) | P(e) | Συνεισφορά |
|---|---|---|---|---|
| B=T, E=T (Διάρρηξη ΚΑΙ Σεισμός) | 0.95 | 0.001 | 0.002 | 0.95×0.001×0.002 ≈ 0.0000019 |
| B=T, E=F (ΜΟΝΟ Διάρρηξη) | 0.94 | 0.001 | 0.998 | 0.94×0.001×0.998 ≈ 0.000938 |
| B=F, E=T (ΜΟΝΟ Σεισμός) | 0.29 | 0.999 | 0.002 | 0.29×0.999×0.002 ≈ 0.000580 |
| B=F, E=F (ΤΙΠΟΤΑ — λάθος) | 0.001 | 0.999 | 0.998 | 0.001×0.999×0.998 ≈ 0.000997 |

$$P(A) \approx 0.0000019 + 0.000938 + 0.000580 + 0.000997 \approx \mathbf{0.0025}$$

> Ερμηνεία: σε μια τυχαία μέρα, υπάρχει **0.25% πιθανότητα** να χτυπήσει ο συναγερμός. Αυτός ο αριθμός χρησιμεύει ως **παρονομαστής** στον τύπο Bayes — κανονικοποιεί το αποτέλεσμα.
...
**Αιτιώδης συλλογισμός για κάθε κελί** — γιατί η ασθένεια *προκαλεί* αυτό το αποτέλεσμα:

* **Α & Ασθ=T (+80):** Η ασθένεια υπάρχει → η Θεραπεία Α επενεργεί στην αιτία → αποτελεσματική ίαση.
* **Α & Ασθ=F (−10):** Δεν υπάρχει αιτία → η Θεραπεία Α δρα χωρίς στόχο → προκαλεί μόνο παρενέργειες.
* **Β & Ασθ=T (+60):** Η ασθένεια υπάρχει → η Θεραπεία Β επενεργεί στην αιτία, αλλά πιο ήπια → μέτρια ίαση.
* **Β & Ασθ=F (+5):** Δεν υπάρχει αιτία → η Θεραπεία Β είναι ήπια, δεν βλάπτει, ελαφρά ωφέλιμη.
* **Καμία & Ασθ=T (−50):** Η ασθένεια υπάρχει → καμία παρέμβαση → η αιτία εξελίσσεται ανεξέλεγκτα.
* **Καμία & Ασθ=F (+10):** Δεν υπάρχει αιτία → δεν χρειαζόταν παρέμβαση → αποφύγαμε περιττό κόστος.
...
**Από BN σε ML:** Τα Δίκτυα Bayes απαιτούν εμπειρογνώμονα που ορίζει χειροκίνητα τη δομή και τους πίνακες πιθανοτήτων. Ο Naive Bayes κάνει το ίδιο πράγμα μαθηματικά, αλλά **μαθαίνει τις πιθανότητες αυτόματα από δεδομένα** — χωρίς χειροκίνητη κωδικοποίηση. Αυτό είναι το βήμα προς τη Μηχανική Μάθηση.

**Ιδέα:** Έχουμε ένα email. Θέλουμε να αποφασίσουμε: Spam ή Ham; Κοιτάμε τις λέξεις και ρωτάμε: «πόσο συχνά εμφανίζεται αυτή η λέξη σε Spam και πόσο σε Ham;» — αυτό το *μαθαίνουμε* από χιλιάδες παλιά emails.

**Η "αφελής" υπόθεση:** Κάθε λέξη μετράει *ανεξάρτητα* από τις άλλες. Έτσι απλώς **πολλαπλασιάζουμε** τις επιμέρους πιθανότητες.

**Παράδειγμα:** email με τις λέξεις "δωρεάν" και "κέρδισε":

| | P(κλάση) | P("δωρεάν" \| κλάση) | P("κέρδισε" \| κλάση) | Γινόμενο |
|---|---|---|---|---|
| **Spam** | 0.50 | 0.80 | 0.70 | 0.50 × 0.80 × 0.70 = **0.280** |
| **Ham** | 0.50 | 0.05 | 0.02 | 0.50 × 0.05 × 0.02 = **0.001** |

Κανονικοποίηση (ώστε να αθροίζουν σε 1):

$$P(\text{Spam}) = \frac{0.280}{0.280 + 0.001} \approx \mathbf{99.6\%} \rightarrow \text{Spam}$$

> **Γιατί "Naive" (Αφελής);** Στην πραγματικότητα οι λέξεις δεν είναι ανεξάρτητες — "κέρδισε" και "δωρεάν" συνεμφανίζονται συχνά στα spam. Η αφελής υπόθεση αγνοεί αυτή τη συσχέτιση, αλλά στην πράξη ο αλγόριθμος παρόλα αυτά λειτουργεί εξαιρετικά καλά.

...
# Τι είναι τα Βαϋεσιανά Δίκτυα (Bayesian Networks);

Τα Βαϋεσιανά Δίκτυα είναι **γραφικά πιθανοτικά μοντέλα** που αναπαριστούν ένα σύνολο μεταβλητών και τις μεταξύ τους εξαρτήσεις. Χρησιμοποιούνται ευρέως στην Τεχνητή Νοημοσύνη για τη **λήψη αποφάσεων υπό συνθήκες αβεβαιότητας**.
...
Το μεγάλο πλεονέκτημα των Βαϋεσιανών Δικτύων είναι ότι μας επιτρέπουν να "ταξιδέψουμε" στο γράφημα προς οποιαδήποτε κατεύθυνση, μόλις παρατηρήσουμε ένα νέο δεδομένο (Evidence):
...
**Συμπέρασμα:** Το Βαϋεσιανό δίκτυο μιμείται την ανθρώπινη λογική χρησιμοποιώντας αυστηρά μαθηματικά!
...
Το Βαϋεσιανό δίκτυο έκανε αυτόν τον υπολογισμό σε κλάσματα του δευτερολέπτου!
...
<img src="../lectures_material/bayes_credit_net.png" alt="Δίκτυο Bayes — Πιστωτικό Ρίσκο" height="80%">



> Δίνοντας νέα στοιχεία (π.χ. εισόδημα αιτούντος), το δίκτυο **ενημερώνει αυτόματα** όλες τις πιθανότητες σε κάθε κόμβο μέσω του θεωρήματος Bayes.
...
<img src="../lectures_material/server_bn_graph.png" alt="Δίκτυο Bayes — Διάγνωση Server" height="70%">

**Ερώτηση:** Αν λάβουμε παράπονα (P=T), ποια η πιθανότητα DDoS vs. Hardware αστοχία;

---

# Παράδειγμα BN — Πίνακες CPT



<img src="../lectures_material/server_bn_cpts.png" alt="CPT πίνακες" height="70%">
...
<img src="../lectures_material/influence_diagram.png" alt="Influence Diagram — Ιατρική Θεραπεία" height="70%">

> Επιλέγεται η θεραπεία που **μεγιστοποιεί** την αναμενόμενη χρησιμότητα. Τα Influence Diagrams ενοποιούν **αβεβαιότητα + αποφάσεις + προτιμήσεις** σε ένα μοντέλο. *(Kjaerulff & Madsen, 2013)*

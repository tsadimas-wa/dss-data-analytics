...
**Ιδέα:** Έχουμε ένα email. Θέλουμε να αποφασίσουμε: Spam ή Ham; Κοιτάμε τις λέξεις που περιέχει και ρωτάμε: «πόσο συχνά εμφανίζεται αυτή η λέξη σε Spam και πόσο συχνά σε Ham;»

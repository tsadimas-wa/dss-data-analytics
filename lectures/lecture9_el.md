...
<!--
Καλωσορίσατε στην 9η Ενότητα του μαθήματος! 
Σήμερα θα κάνουμε μια βαθιά βουτιά στον κόσμο των Ευφυών Πρακτόρων και των Πολυπρακτορικών Συστημάτων. Θα ξεκινήσουμε από τις κλασικές θεωρίες της Τεχνητής Νοημοσύνης (ορισμοί, χαρακτηριστικά, αρχιτεκτονικές) και θα δούμε πώς αυτά τα ίδια θεμέλια αποτελούν σήμερα τον πυρήνα των υπερσύγχρονων συστημάτων, όπως οι αυτόνομοι LLM πράκτορες.
Πρόκειται για μια γέφυρα από την κλασική λογική στα σύγχρονα Agentic Workflows!
-->
...
<!--
Αυτή η ενότητα αποτελεί έναν «οδικό χάρτη» — πριν ξεκινήσετε, δείξτε στους φοιτητές το συνολικό ταξίδι. Ξεκινάμε από τις κλασικές θεωρίες των πρακτόρων (ορισμοί, χαρακτηριστικά, αρχιτεκτονικές) και φτάνουμε στα σύγχρονα LLM-based agentic systems. Δώστε έμφαση στη γέφυρα: η θεωρία BDI του 1987, τα Πολυπρακτορικά Συστήματα και τα GDSS δεν είναι ξεπερασμένα — είναι ακριβώς τα θεωρητικά θεμέλια του ChatGPT, του CrewAI και κάθε σύγχρονου AI Agent!
-->
...
<!--
Η ταξινόμηση Franklin & Graesser μας δίνει το πλαίσιο: ξεκινάμε πάντα ρωτώντας «ποια είναι η φύση του πράκτορα; Έχει σώμα; Υπάρχει στον ψηφιακό ή φυσικό κόσμο;». Σήμερα εστιαζόμαστε σχεδόν αποκλειστικά στους Softbots — το πεδίο που «εκρήγνυται» με τα LLMs. Αξίζει να σημειώσετε ότι ακόμα και τα αυτόνομα οχήματα (Tesla Autopilot) είναι στην ουσία Υβριδικοί πράκτορες: έχουν λογισμικό που «σκέφτεται» (cloud AI) και φυσικούς μηχανισμούς δράσης (τιμόνι, φρένα).
-->

---

# Ορισμοί τεχνητών πρακτόρων

Ένας πράκτορας (**agent**) είναι οποιαδήποτε οντότητα μπορεί να αντιλαμβάνεται το περιβάλλον (**environment**) της με τη βοήθεια αισθητήρων (**sensors**) και να δρα πάνω σε αυτό το περιβάλλον με τη βοήθεια μηχανισμών δράσης (**actuators, effectors**).


![](../img/lec9/def-agent.png)

<!--
Αυτός είναι ο πιο βασικός ορισμός — η «ατομική μονάδα» κατανόησης. Κάθε φορά που συναντάμε ένα σύστημα AI, αναρωτόμαστε: «Τι αισθητήρες έχει; Τι μπορεί να κάνει;» Η εικόνα αποτυπώνει τον κύκλο αντίληψης-δράσης που χαρακτηρίζει κάθε πράκτορα, από τον πιο απλό θερμοστάτη έως το πιο σύνθετο LLM Agent. Κρατήστε αυτό το διάγραμμα στο μυαλό σας — θα το βλέπουμε ξανά και ξανά σε κάθε αρχιτεκτονική.
-->
...
<!--
Αυτή η διαφάνεια εξηγεί γιατί οι πράκτορες BDI (Ισχυρή Θεώρηση) δεν ανήκουν μόνο στη θεωρία — χρησιμοποιούνται σε πολύπλοκα συστήματα διαπραγμάτευσης και ηθικής ΑΙ. Κάθε φορά που ένα AI σύστημα πρέπει να αιτιολογήσει τις αποφάσεις του (explainability) ή να ενσωματώσει αξίες και κανόνες, η Ισχυρή Θεώρηση είναι η φυσική επιλογή. Αντίθετα, για έναν spam filter δεν χρειαζόμαστε το σύστημα να «θέλει» ή «πιστεύει» κάτι — αρκεί να συμπεριφέρεται σωστά (Χαλαρή Θεώρηση). Η επιλογή μεταξύ τους είναι αρχιτεκτονική απόφαση, όχι φιλοσοφική συζήτηση!
-->
...
Για να κατανοήσουμε και να προβλέψουμε τη συμπεριφορά πολύπλοκων ευφυών συστημάτων, ο φιλόσοφος **Daniel Dennett (1987)** πρότεινε τρία επίπεδα αφαίρεσης (*stances*):

<div class="columns">
<div>

**1. Φυσική Προσέγγιση (Physical Stance)**
- **Εστίαση:** Υλικό (hardware) και φυσικοί νόμοι.
- **Λογική:** Το σύστημα δρα έτσι λόγω των φυσικών ιδιοτήτων των κυκλωμάτων του.
- **Παράδειγμα (Σκάκι):** *"Η κίνηση έγινε επειδή το ρεύμα πέρασε από τον επεξεργαστή."*
- **Χρησιμότητα:** Εντελώς άχρηστη για την κατανόηση της στρατηγικής.

**2. Σχεδιαστική Προσέγγιση (Design Stance)**
- **Εστίαση:** Κώδικας, αλγόριθμοι και αρχιτεκτονική.
- **Λογική:** Το σύστημα δρα έτσι γιατί *προγραμματίστηκε* να ακολουθεί αυτούς τους κανόνες.
- **Παράδειγμα (Σκάκι):** *"Μετακίνησε το πιόνι επειδή ο αλγόριθμος Minimax αξιολόγησε το δέντρο αποφάσεων."*

</div>
<div>

**3. Προθεσιαρχική Προσέγγιση (Intentional Stance)**
- **Εστίαση:** Στις νοητικές καταστάσεις. Αντιμετωπίζουμε το AI σαν να έχει *γνώση* και *προθέσεις*.
- **Λογική:** Δρα με βάση όσα «πιστεύει» (beliefs) για να πετύχει όσα «θέλει» (desires).
- **Παράδειγμα (Σκάκι):** *"Το πρόγραμμα μετακίνησε τον ίππο επειδή **θέλει** να προστατέψει τη βασίλισσα."*

<div style="background: #f0f8ff; padding: 12px; border-left: 4px solid #007bff; border-radius: 4px; margin-top: 15px;">
<strong>💡 Η Αξία της Προθεσιαρχικής:</strong> Όταν ένα σύστημα γίνεται υπερβολικά πολύπλοκο (π.χ. LLMs), η ανάλυση του κώδικα (Design Stance) δεν επαρκεί. Η απόδοση "προθέσεων" είναι ο μόνος πρακτικός τρόπος να προβλέψουμε και να κατευθύνουμε τη συμπεριφορά του!
</div>
...
<!--
Ο Daniel Dennett μας προσφέρει ένα εξαιρετικό φιλοσοφικό εργαλείο, απολύτως πρακτικό στην Τεχνητή Νοημοσύνη. 
Σκεφτείτε ένα σύγχρονο Μεγάλο Γλωσσικό Μοντέλο (LLM) όπως το ChatGPT. Αν προσπαθήσουμε να εξηγήσουμε γιατί μας έδωσε μια συγκεκριμένη απάντηση χρησιμοποιώντας τη Φυσική Προσέγγιση (τα ηλεκτρόνια στους servers) ή τη Σχεδιαστική Προσέγγιση (δισεκατομμύρια βάρη και πολλαπλασιασμοί πινάκων), θα αποτύχουμε παταγωδώς. Το σύστημα είναι υπερβολικά πολύπλοκο. 
Ο μόνος τρόπος να αλληλεπιδράσουμε μαζί του -και το κάνουμε διαισθητικά- είναι η Προθεσιαρχική Προσέγγιση: Λέμε "το μοντέλο θεώρησε ότι του ζήτησα κάτι άλλο" ή "προσπαθεί να αποφύγει το θέμα". Του αποδίδουμε ανθρώπινες προθέσεις. Αυτό δεν σημαίνει ότι το AI έχει συνείδηση, αλλά ότι το Intentional Stance είναι το απολύτως αναγκαίο επίπεδο αφαίρεσης για να το διαχειριστούμε ως εργαλείο!
-->
...
<!--
Αυτή η διαφάνεια είναι η γέφυρα ανάμεσα στη φιλοσοφία και την αρχιτεκτονική επιλογή. Ο ππρακτικός κανόνας: αν αναπτύσσετε ένα spam filter, χρειάζεστε μόνο τη Σχεδιαστική προσέγγιση. Αν αναπτύσσετε ένα σύστημα διαπραγμάτευσης ήθικής AI, χρειάζεστε την Προθεσιαρχική — το σύστημα πρέπει να «καταλαβαίνει» τι επιδιώκει και τι αποφεύγει. Αν κάνετε prompt engineering σε ένα LLM, χρησιμοποιείτε αυτομάτα την Προθεσιαρχική: «θέλω να καταλάβεις ότι...», «προσποιήσου ότι είσαι...». Αυτό είναι η Intentional Stance σε δράση!
-->
...
<!--
Μια εικόνα αξίζει χίλιες λέξεις. Στη διαφάνεια βλέπουμε ότι η ιεραρχία δεν είναι «σκαλά» νοημοσύνης — οι ιοί και τα κακόβουλα είναι τεχνικά αυτόνομοι πράκτορες με υψηλή αντιδραστικότητα και αυτονομία. Δείχνει επίσης ότι η νοημοσύνη δεν είναι απαραίτητα συνδεδεμένη με τον ευεργετισμό ή την ηθική συμπεριφορά. Αυτό το δέντρο μας δίνει την ολοκληρωμένη εικόνα του χώρου, στα όρια του οποίου κινούμαστε σήμερα με τα LLM-based συστήματα.
-->
...
<!--
Η κατηγορία των ιών είναι μια τέλεια παραδοξολογία στην επιστήμη των πρακτόρων. Ο worm Morris (1988) ή τα σύγχρονα ransomware botnets αντιμετωπίζουν πλήρως αυτόνομα, αντιδραστικά και αυτο-αναπαραγόμενα βάσει περιβάλλοντος. Αυτό μας υπενθυμίζει ότι η αυτονομία είναι αδύναμη εργαλείο χωρίς σωστούς στόχους και δικλείδες (ασφάλεια). Γι' αυτό το πρώτο βήμα στο σχεδιασμό κάθε AI Agent είναι να ορίσουμε ξεκάθαρα τι επιτρέπεται να κάνει και τι όχι.
-->
...
![w:580](../img/lec9/ag-maes.png)

</div>
</div>

<!--
Ο Russell & Norvig μας δίνουν τη βάση: αισθητήρες → εγκέφαλος → ενεργοποιητές. Η Maes προσθέτει την κρίσιμη έννοια της αυτονομίας σε πολύπλοκο περιβάλλον: ο πράκτορας δεν απαιτεί συνεχή ανθρώπινη επίβλεψη για κάθε βήμα. Μπορείτε να βλέπετε πώς κάθε επόμενη αρχιτεκτονική που θα δούμε είναι βαθμιαία ανάπτυξη επάνω σε αυτόν τον κύκλο, προσθέτοντας μνήμη, στόχους, και συνεργασία.
-->
...
<!--
Ο Coen φέρνει την κοινωνική διάσταση, ενθέτουςα τη λογική διαπραγμάτευση στον κύκλο. Αυτό είναι το θεμέλιο των Πολυπρακτορικών Συστημάτων (MAS): οι πράκτορες δεν είναι μόναχοι — μιλούν μεταξύ τους, διαπραγματεύονται και συντονίζουν τη ροή των πληροφοριών. Σκεφτείτε επίσης το FIPA ACL που θα δούμε αργότερα σε αυτή την ενότητα — είναι ακριβώς η υλοποίηση της ιδέας του Coen σε πρότυπο.
-->

---

# Λογικοί (ευφυείς) πράκτορες
**Οι λογικοί πράκτορες** κάνουν συνεχώς τις εξής τρεις λειτουργίες: 
* αντιλαμβάνονται τις δυναμικές συνθήκες του περιβάλλοντος, 
* δρουν πάνω στο περιβάλλον ώστε να το αλλάξουν και 
...
![](../img/lec9/ag-smart.png)

<!--
Ο ορισμός αυτός των Hayes-Roth είναι ίσως ο πιο σύνθετος αλλά και ο πιο πλήρης. Παρατηρήστε τις τρεις λέξεις-κλειδιά: αντιλαμβάνονται, δρουν, συλλογίζονται. Αυτός είναι ο κύκλος ενός ευφυούς πράκτορα. Δεν αντιδρά απλώς σε ερεθίσματα όπως ενεργεί ένας θερμοστάτης — ερμηνεύει αυτό που βλέπει, συμπεραίνει, και μετά δρα στοχαστικά άρα αποφασίζει. Είναι ακριβώς αυτό που κάνει και ο γιατρός όταν διαγνώσκει μια ασθένεια ή το ChatGPT όταν απαντά σε σύνθετη ερώτηση.
-->

---

# Πράκτορες με εσωτερική κατάσταση

Οι Λογικοί Πράκτορες που έχουν επιπλέον σκοπιμότητες λέγονται πράκτορες με εσωτερική κατάσταση : 
* Έχουν μια συμβολική αναπαράσταση του κόσμου μέσα στον οποίο βρίσκονται που τους επιτρέπει να βλέπουν πώς αυτός εξελίσσεται. 
* Έχουν στόχο και σκοπιμότητες.

![](../img/lec9/ag-state.png)

<!--
Η εσωτερική κατάσταση είναι το πρώτο βήμα προς τη «νοημοσύνη». Αν είχαμε έναν απλό αντιδραστικό πράκτορα που δεν θυμάται τίποτα, αρκεί να μετακινηθεί η γάτα από τη μεριά του για να τον απενεργοποιήσει! Προσθέτοντας όμως την εσωτερική κατάσταση (μνήμη + μοντέλο κόσμου), ο πράκτορας αρχίζει να έχει μια «άποψη» για τον κόσμο, να καταλαβαίνει τι συμβαίνει εκτός του οπτικού του πεδίου και να σχεδιάσει πιο έξυπνες δράσεις. Αυτό είναι το θεμέλιο πάνω στο οποίο χτίζεται κάθε προηγμένη αρχιτεκτονική που θα δούμε (BDI, υβριδικοί, μαθαίνουν).
-->
...
![](../img/lec9/ag-axes.png)

<!--
Σε αυτή τη διαφάνεια αποτυπώνονται οπτικά οι βασικοί άξονες πάνω στους οποίους ταξινομούμε την πολυπλοκότητα ενός πράκτορα. Σκεφτείτε το σαν έναν τρισδιάστατο χώρο:
1. **Άξονας Νοημοσύνης (Intelligence):** Ξεκινάμε από απλά, "τυφλά" αντανακλαστικά και κανόνες, προχωράμε στον σχεδιασμό πλάνων, και καταλήγουμε σε πράκτορες που μαθαίνουν από το περιβάλλον (ML/RL).
2. **Άξονας Κινητικότητας (Mobility):** Στη βάση έχουμε τους στατικούς πράκτορες. Πιο πάνω αυτούς που καλούν απομακρυσμένες διαδικασίες (RPC/APIs), και στην κορυφή τους κινητούς (mobile) πράκτορες που μεταφέρουν τον κώδικα και την κατάστασή τους σε άλλους servers.
3. **Άξονας Συνεργασίας/Επικοινωνίας (Agency/Cooperation):** Ξεκινάμε από μεμονωμένους πράκτορες, προχωράμε σε απλή ανταλλαγή μηνυμάτων και φτάνουμε σε πλήρη Πολυπρακτορικά Συστήματα (MAS) με διαπραγματεύσεις, δημοπρασίες και συνεργατική επίλυση προβλημάτων.
Όσο πιο ψηλά βρισκόμαστε σε αυτούς τους άξονες, τόσο πιο "έξυπνο" αλλά και δύσκολο στην υλοποίηση είναι το σύστημά μας.
-->
...
<!--
Ο Andrew Ng επισημαίνει ότι το μέλλον της AI δεν είναι απλά ένα τεράστιο μοντέλο LLM που απαντάει μονοκοπανιά (zero-shot prompt). Το πραγματικό άλμα έρχεται όταν εντάξουμε το μοντέλο σε "Ροές Εργασίας" (Workflows).
Δίνοντας στο μοντέλο χρόνο να σκεφτεί, να γράψει, να αυτο-διορθωθεί (Reflection) και να δράσει με εξωτερικά εργαλεία (Tool Use), η απόδοσή του εκτοξεύεται και συγκρίνεται με ομάδες ανθρώπων-προγραμματιστών!
-->
...
Το ακρωνύμιο **PEAS** (Russell & Norvig) ορίζει τις τέσσερις θεμελιώδεις διαστάσεις για τον σχεδιασμό ενός ορθολογικού πράκτορα. Αποτελεί το **πρώτο βήμα** πριν επιλεγεί η αρχιτεκτονική ή γραφτεί κώδικας!


**Οι 4 Διαστάσεις:**
- **P**erformance (Απόδοση): *Πώς μετράμε την επιτυχία;* Τι προσπαθεί να βελτιστοποιήσει ο πράκτορας;
- **E**nvironment (Περιβάλλον): *Ποιος είναι ο "κόσμος" του;* Με τι συνθήκες έρχεται αντιμέτωπος;
- **A**ctuators (Ενεργοποιητές): *Πώς επιδρά στον κόσμο;* Ποιοι είναι οι μηχανισμοί δράσης του;
- **S**ensors (Αισθητήρες): *Πώς αντιλαμβάνεται τον κόσμο;* Πώς συλλέγει δεδομένα;



**Άλλα Παραδείγματα PEAS:**

| Πράκτορας | Performance | Environment | Actuators | Sensors |
|---|---|---|---|---|
| **Spam filter** | % ταξινόμησης, false positives | Email inbox | Spam/inbox φάκελος | Κείμενο, headers |
| **Trading** | Κέρδος, ελαχιστοποίηση ρίσκου | Χρηματιστήριο | Εντολές αγοράς/πώλησης | Ιστορικό τιμών, νέα |

<br>

<div style="background: #f0f8ff; padding: 12px; border-left: 4px solid #007bff; border-radius: 4px;">
<strong>💡 Σημαντικό:</strong> Η σωστή οριστικοποίηση του P (Performance) είναι κρίσιμη για να αποφευχθούν ανεπιθύμητες συμπεριφορές στο σύστημα!
</div>
...
<!--
Όπως είδαμε και στα προηγούμενα παραδείγματα (Ταξί, Ιατρικό, Ρομπότ), το ακρωνύμιο PEAS είναι το απόλυτο "Συμβόλαιο Απαιτήσεων" (Requirements Document) στον σχεδιασμό οποιουδήποτε ευφυούς συστήματος. 
Το πιο κρίσιμο από όλα είναι το "P" (Performance). Αν δεν έχουμε ορίσει καθαρά πώς μετράμε την επιτυχία (το objective function), το σύστημα δεν θα ξέρει τι να βελτιστοποιήσει. 
Για παράδειγμα, αν σε μια σκούπα ρομπότ ορίσουμε ως "P" ΜΟΝΟ το πόση σκόνη μαζεύει (χωρίς να την τιμωρούμε για τον χρόνο ή τον θόρυβο), μπορεί να αρχίσει να αδειάζει τη σκόνη που μάζεψε πίσω στο πάτωμα για να τη μαζέψει ξανά και να μεγιστοποιήσει το σκορ της! Γι' αυτό το PEAS απαιτεί μεγάλη προσοχή.
-->
...
<!--
Η ισορροπία ανάμεσα στα Κύρια και τα Δευτερεύοντα χαρακτηριστικά εξαρτάται πλήρως από τη χρήση. Ένας spam filter χρειάζεται μόνο αντιδραστικότητα και αυτονομία. Ένας trading bot σε χρηματιστήριο χρειάζεται επιπλέον προσαρμοστικότητα και λογικότητα. Ένας κοινωνικός ρομπότ (π.χ. Pepper) χρειάζεται και αγαθή προαίρεση για να αλληλεπιδράσει φυσικά με ανθρώπους. Τα τρία επίπεδα στους Άξονες Χαρακτηρισμού αποτελούν έναν εύκολο τρόπο να αξιολογήσετε πόσο «προχωρημένος» είναι ένας πράκτορας — ρωτήστε: «Πού βρίσκεται στον κάθε άξονα;»
-->
...
**Οι πράκτορες πρέπει να είναι ορθολογιστικοί:**

- Ένας ευφυής (λογικός) πράκτορας πρέπει να πασχίζει να **“κάνει το σωστό”**, βασιζόμενος στη γνώση που έχει ενσωματωμένη, στο τι μπορεί να αντιληφθεί και στο πώς μπορεί να δράσει.
- **Η σωστή ενέργεια** είναι αυτή που θα επιτρέψει στον πράκτορα να είναι πιο επιτυχής.
- **Μέτρηση επίδοσης:** Ένα αντικειμενικό κριτήριο επιτυχίας της συμπεριφοράς του πράκτορα.

<!--
Συνδέουμε τον ορθολογισμό με το PEAS που είδαμε πριν. Ο ορθολογισμός δεν σημαίνει τελειότητα ή παντογνωσία — σημαίνει τη βέλτιστη δυνατή απόφαση βάσει των διαθέσιμων πληροφοριών. Είναι η διαφορά μεταξύ ενός γιατρού που έχει όλες τις απαντήσεις και απλώς δεν σκέφτεται να εξετάσει τον ασθενή (μη ορθολογικός) και ενός γιατρού που διαγνώζει συστηματικά βάσει συμπτωμάτων και αποτελεσμάτων εξετάσεων (ορθολογικός).
-->

---

<!-- _class: xsmall -->
# Σχεδιασμός Ορθολογικού Πράκτορα (Παραδείγματα)

<div class="columns">
<div>

**Παράδειγμα 1: Πράκτορας-Οδηγός Ταξί**
- **Μέτρηση επίδοσης:** Ασφάλεια, ταχύτητα, νομιμότητα, άνεση ταξιδιού
- **Περιβάλλον:** Δρόμοι, άλλη κίνηση, πεζοί, πελάτες
- **Μηχανισμοί δράσης:** Τιμόνι, λεβιές ταχυτήτων, φρένα, φλας, κόρνα
- **Αισθητήρες:** Κάμερες, ηχητικός εντοπιστής, μετρητής ταχύτητας, GPS, χιλιομετρητής, πληκτρολόγιο

**Παράδειγμα 2: Ιατρικό Σύστημα Διάγνωσης**
- **Μέτρηση επίδοσης:** Υγιής ασθενής, ελαχιστοποίηση κόστους, αγωγές
- **Περιβάλλον:** Ασθενής, νοσοκομείο, προσωπικό
- **Μηχανισμοί δράσης:** Οθόνη (ερωτήσεις, τεστ, διαγνώσεις, ιατρική αγωγή, εναλλακτικές λύσεις)
- **Αισθητήρες:** Πληκτρολόγιο (εισαγωγή συμπτωμάτων, αποτελέσματα εξετάσεων, απαντήσεις ασθενούς)

</div>
<div>

**Παράδειγμα 3: Ρομπότ Συλλογής Κομματιών**
- **Μέτρηση επίδοσης:** Ποσοστό κομματιών στο σωστό δοχείο
- **Περιβάλλον:** Κομμάτια, ιμάντας μεταφοράς κομματιών, δοχεία
- **Μηχανισμοί δράσης:** Συνδεδεμένο χέρι με βραχίονα
- **Αισθητήρες:** Κάμερα, αισθητήρες εντοπισμού

</div>
</div>

<!--
Εδώ βλέπουμε την έννοια του Ορθολογισμού. Ένας πράκτορας δεν είναι τέλειος ούτε παντογνώστης. Ορθολογικός σημαίνει ότι κάνει το καλύτερο που μπορεί, με βάση τα δεδομένα που διαθέτει εκείνη τη στιγμή.
Για να σχεδιάσουμε έναν τέτοιο πράκτορα, πρέπει να ορίσουμε ξεκάθαρα το Κριτήριο Επίδοσης, το Περιβάλλον, τους Μηχανισμούς Δράσης (Ενεργοποιητές) και τους Αισθητήρες. Βλέπετε στα τρία παραδείγματα πώς ο ίδιος σκελετός εφαρμόζεται σε εντελώς διαφορετικά προβλήματα.
-->
...
<!--
Κλείνοντας, κρατήστε το εξής: Η θεωρία των πρακτόρων υπήρχε δεκαετίες πριν την έκρηξη του ChatGPT. Έννοιες όπως το BDI, τα πρωτόκολλα μηνυμάτων και η κατανομή εργασιών (MAS) δεν είναι ξεπερασμένες· αποτελούν τα θεωρητικά θεμέλια πάνω στα οποία χτίζονται τα υπερσύγχρονα συστήματα AI του σήμερα και του αύριο.
...
<!-- _class: small -->
# Αντιδραστικοί Πράκτορες — Απλός Αντιδραστικός (Simple Reflex Agent)
...
![](../img/lec9/ag-react.png)

</div>
<div>

![](../img/lec9/ag-react-simple.png)

</div
</div>

<!--
Ο Απλός Αντιδραστικός είναι η απόλυτη απλοποίηση. Σκεφτείτε ένα ρομπότ ηλεκτρικής σκούπας (Roomba): βλέπει ότι σκοντάφτει σε εμπόδιο, στρίβει. Βλέπει ότι η μπαταρία είναι χαμηλή, επιστρέφει στη βάση. Κανένας σχεδιασμός, καμία μνήμη για το πού ήταν πριν. Παρ' όλα αυτά, καθαρίζει το δωμάτιο ικανοποιητικά!
Το κύριο μάθημα: η απλότητα έχει αξία. Δεν χρειάζεται πάντα ο πιο έξυπνος πράκτορας. Ο σωστός πράκτορας για το σωστό περιβάλλον.
-->
...
# Αντιδραστικός με Μοντέλο (Model-Based Reflex Agent)

<div class="columns">
<div>

![](../img/lec9/ag-react-model.png)
...
<!--
Ο Model-Based Reflex λύνει το μεγαλύτερο πρόβλημα του Simple Reflex: τι γίνεται όταν δεν μπορούμε να δούμε όλο το περιβάλλον; Η απάντηση είναι απλή αλλά ισχυρή: κράτα ένα νοητικό μοντέλο του κόσμου!
Όπως ο οδηγός που ξέρει ότι ένα φορτηγό υπάρχει στη νεκρή γωνία του ακόμα κι αν δεν το βλέπει — επειδή το είδε να μπαίνει εκεί — ο Model-based πράκτορας χτίζει και ενημερώνει συνεχώς μια εσωτερική αναπαράσταση του κόσμου.
Αυτή η "εσωτερική κατάσταση" είναι το κλειδί για την κατανόηση όλων των σύνθετων αρχιτεκτονικών που ακολουθούν.
-->

---

# Μάθηση αντιδραστικών πρακτόρων βασισμένων σε μοντέλα


![](../img/lec9/ag-react-model-learn.png)

<!--
Η εικόνα αυτή αποτυπώνει την επόμενη εξελικτική βαθμίδα: αντί ο κόσμος να είναι σταθερός και ο πράκτορας να χρησιμοποιεί απλώς ένα εφεδρικό μοντέλο, τώρα έχουμε και ένα στοιχείο Μάθησης. Το μοντέλο του κόσμου δεν είναι πλέον στατικό — βελτιώνεται συνεχώς μέσα από την εμπειρία! Αυτό είναι το πρώτο βήμα προς τους πράκτορες που μαθαίνουν, τους οποίους θα δούμε αναλυτικά σε επόμενη διαφάνεια.
-->

---

# Αντιδραστικοί Πράκτορες (Στόχου & Χρησιμότητας)
...
<!--
Αυτή η διαφάνεια αποτυπώνει την ιστορική διαδρομή της AI. 
Ξεκινάμε από απλούς μηχανισμούς (Russell), περνάμε σε αυτόνομα συστήματα (Maes), τους προσθέτουμε "μυαλό" και λογική (Hayes-Roth) και τελικά τα μαθαίνουμε να μιλάνε και να συνεργάζονται (Coen). 
Κρατήστε τον τύπο κάτω δεξιά: Ο πράκτορας δεν ζει σε κενό. Υπάρχει ένας συνεχής κύκλος ανατροφοδότησης (feedback loop) με το περιβάλλον του!
-->
...
<!--
Το BDI είναι η αρχιτεκτονική που «μιλάει» ιντυιτικά στον άνθρωπο. Οι ίδιες έννοιες χρησιμοποιείται και στην καθημερινή ζωή: όταν ακούτε ειδήσεις (Beliefs: αναβαθμίζετε γνώση), ξεκινάτε να επιθυμείτε να πάτε εκδρομή (Desire), αλλά την χαλάτε επειδή έχετε χρήματα να πληρώσετε, και τελικά αποφασίζετε να πάτε το ΢εκινόυ (Intention). Αυτός είναι ο BDI κύκλος σε δράση. Χρησιμοποιείται σε συστήματα εναέριας ατυχημάτων, σε αυτόνομη διαχείριση ασθενών, αλλά και σε μοντέλα ηθικής AI όπου ο πράκτορας πρέπει να εξηγεί τις αποφάσεις του.
-->

---

# Πράκτορες με σκοπιμότητες

![](../img/lec9/ag-scope.png)

<!--
Αυτή η διαφάνεια δείχνει οπτικά τη διαφορά μεταξύ ενός αντιδραστικού πράκτορα (χωρίς διαθέσεις αλλά με σκοπιμότητες) και ενός πράκτορα με πλήρη BDI αρχιτεκτονική. Σκεφτείτε το ως εξέλιξη από «αντανακλαστικό» σε «σκόπιμο»: ο πράκτορας αποκτά στόχους που επιδιώκει ενεργά, όχι απλώς συμπεριφόρες που αντιδρά στα ερεθίσματα.
-->

---

# Πράκτορες με προθέσεις

![](../img/lec9/ag-int.png)

<!--
Η έννοια των προθέσεων είναι το αποκορυφωματικό στοιχείο του BDI: η δέσμευση. Ο πράκτορας δεν αρκείται να «θέλει» κάτι — δεσμεύεται να το κάνει. Αυτή η δέσμευση είναι που κάνει τον πράκτορα αξιόπιστο και αποτελεσματικό: δεν αλλάζει συνεχώς γνώμη ανάλογα με κάθε νέα πληροφορία, αλλά εμμένει σε αυτό που αποφάσισε μέχρι τέλους ή μέχρι το σκοπός να κριθεί αδύνατος.
-->
...
<!--
Ο Dennett μάς δίνει ένα φιλοσοφικό, αλλά πολύ πρακτικό εργαλείο. 
Σκεφτείτε ένα σύγχρονο Μεγάλο Γλωσσικό Μοντέλο (LLM). Αν προσπαθήσετε να καταλάβετε γιατί σας έδωσε μια λάθος απάντηση εξετάζοντας τα δισεκατομμύρια βάρη του (Φυσική/Σχεδιαστική προσέγγιση), θα χαθείτε. 
Ο μόνος τρόπος να αλληλεπιδράσουμε μαζί του -και να το κάνουμε debug- είναι να του αποδώσουμε προθέσεις (Προθεσιαρχική Προσέγγιση): "Το μοντέλο θεώρησε ότι του ζήτησα κάτι άλλο". Είναι το απαραίτητο επίπεδο αφαίρεσης!
-->

---

<!-- _class: xxsmall -->
# Παράδειγμα προθέσεων
...
<!--
Η διαφάνεια αυτή δείχνει ένα κλασικό παράδειγμα BDI: την αντιμετώπιση της πρόθεσης ενός πράκτορα να καταργήσει μια ενέργεια με διαφορετικά αποτελέσματα βάσει των πεποιθήσεων. Χρησιμοποιήστε τη διαγραμματική αναπαράσταση για να συζητήσετε πώς η BDI λογική αποφασίζει αν θα εκτελέσει ή θα αναβάλει ανάλογα με τις τρέχουσες πεποιθήσεις του.
-->
...
<!--
Η αρχιτεκτονική Learning Agents αντικατοπτρίζει τον τρόπο που μαθαίνει ένας άνθρωπος σε νέο αντικείμενο. Ο Performance Element είναι αυτό που ξέρει να κάνει τώρα. Ο Critic παρατηρεί και λέει «αυτό ήταν καλό» ή «μη το κάνεις ξανά». Το Learning Element αλλάζει στρατηγική βάσει αυτής της κριτικής. Και ο Problem Generator προκαλεί: «δοκίμασε κάτι νέο που δεν έχεις κάνει ποτέ!»
Ένα εξαιρετικό παράδειγμα: το AlphaGo Zero έμαθε Go χωρίς ανθρώπινα δεδομένα — παίζοντας εκατομμύρια παρτίδες εναντίον του εαυτού του (self-play). Ο Problem Generator ήταν η τυχαία εξερεύνηση νέων κινήσεων.
-->
...
<!--
Σκεφτείτε τα MAS σαν μια εταιρεία: κανένας εργαζόμενος δεν γνωρίζει όλη την εικόνα (ελλιπής πληροφόρηση), δεν υπάρχει αφεντικός επιβλέπων (αποκέντρωση), αλλά όλοι συνεργάζονται βάσει συμβάσεων (ασύγχρονη εκτέλεση). Αυτό ακριβώς είναι το μόντελο της ανθρώπινης κοινωνίας σε μεγάλες οργανισατικές δομές. Το μεγάλο ζήτημα είναι η Αναδυόμενη Συμπεριφορά: πώς απλοί κανόνες (αρμυρίδες, μέλισσες) δημιουργούν έξυπνη συλλογική συμπεριφορά χωρίς κεντρικό ελεγκτή;
-->
...
<!--
Ο Blackboard και το Message Passing είναι σαν το «εισαγωγικό μάθημα» των αρχιτεκτονικών προτύπων επικοινωνίας στα MAS. Ο Blackboard συναντάται στην πράξη σε συστήματα όπου οι συνθήκες είναι γνωστές εκ των προτέρων (ESBs, shared databases σε enterprise). Το Message Passing είναι το μοντέλο των microservices και των σύγχρονων LLM Agents: η επικοινωνία μέσω μηνυμάτων υψηλού επιπέδου (tool calls, API responses) είναι ακριβώς Message Passing!
-->
...
<!--
Η KQML ήταν η πρώτη σοβαρή προσπάθεια στανδαρδοποίησης της επικοινωνίας πρακτόρων — πριν ακόμα εμφανιστεί το REST/JSON ή τα LLM function calls. Παρατηρήστε τη δομή: Υπάρχει αποστολέας, αποδέκτης, περιεχόμενο και τύπος πράξης (performative: ask-one, inform, subscribe). Αυτή η στρούκτουρα της «πράξης» (περιγράφει την πρόθεση του αποστολέα) είναι η ιδέα που αργότερα ονομάστηκε speech act στη FIPA ACL.
-->
...
<!--
Η FIPA ACL είναι η «γλώσσα διπλωματίας» μεταξύ πρακτόρων. Παρατηρήστε ότι κάθε μήνυμα είναι επισημαντικά: λέει τι θέλει να πετύχει (πραξιολογική: inform, propose, reject), πως είναι η γλώσσα και το επιστημονικό περιεχόμενο (ontology). Στη σύγχρονη LLM εποχή, τα tool calls και τα function schemas (π.χ. OpenAI tool calling JSON) είναι ουσιαστικά FIPA ACL μενούματο. Η ιδέα είναι ίδια — απλώς αλλάξε σύνταξη.
-->
...
<!--
Η επιλογή μεταξύ συνεργασίας, ανταγωνισμού και διαπραγμάτευσης εξαρτάται από τους στόχους του συστήματος. Σε εναέρια αντιμετώπισης χρησιμοποιούμε διαπραγμάτευση (π.χ. σε ασθενοφορεία). Σε εμπορικά συστήματα trading, εφαρμόζουμε ανταγωνισμό βάσει τιμής. Σε supply chain, χρησιμοποιούμε συνεργασία με Contract Net. Και στα GDSS, αποφασίζουμε μέσω διαπραγμάτευσης και συναίνεσης μεταξύ ανθρώπων. Η επιλογή αρχιτεκτονικής είναι αρμοδιότητα με domain.
-->
...
<!--
Αυτό το παράδειγμα είναι πλήρες ρεαλιστικό. Σκεφτείτε ότι δύο εργαζόμενοι διαπραγματεύονται την τιμή ενός ακινήτου. Ο A θέλει να κερδίσει όσο γίνεται, ο B να πουλήσει όσο γίνεται ακριβότερα. Καθώς πλησιάζει το deadline της συναλλαγής, αμφότεροι υποχωρούν (στρατηγική concession). Η μαγική λέξη είναι το ZOPA: αν ο A δεν δεχτεί πάνω από 130€ και ο B δεν πουλάει κάτω από 110€, το ZOPA είναι [110-130€]. Εκτός αυτού του εύρους, δεν γίνεται συμφωνία.
-->
...
<!--
Το Contract Net Protocol είναι το «εργαλείο» της κατανεμημένης επίλυσης προβλημάτων. Έχει εφαρμοστεί σε πρακτικά συστήματα: cloud computing (task dispatching σε workers), logistics (ανάθεση δρομολογίων), αλλά και στους σύγχρονους Agentic Workflows: όταν ένας Orchestrator αναθέτει υποεργασίες σε εξειδικευμένους sub-agents (Coder, WebSurfer, Critic), εκτελεί ουσιαστικά CNP. Ο πρώτος που το πρότεινε ήταν ο Smith το 1980, χρόνια πριν το Internet!
-->
...
<!--
Αυτή η διαφάνεια είναι η γέφυρα μεταξύ κλασικής MAS θεωρίας και πρακτικής εφαρμογής. Οι Interface Agents είναι οι πρόγονοι των σύγχρονων AI assistants. Ο ATC agent είναι ένα παράδειγμα mission-critical συστήματος όπου ο κατακερματισμός έχει αποφασιστικές συνέπειες — συμπτώματα αξιοπιστίας (reliability) και αποφυγής λαθών (hallucinations). Του shopping bot οι σύγχρονες απόγονοι είναι τα LLM agents που βλέπουμε σήμερα (Perplexity, Claude web search) και τα AI συστήματα των e-shops.
-->
...
*Η Λύση GDSS:* Αντί να βάλει 15 κορυφαίους επιστήμονες σε ένα τραπέζι (όπου ο πιο διάσημος/φωνακλάς θα επέβαλε την άποψή του), χρησιμοποιεί λογισμικό Delphi. 
...
<!--
Το Magentic-One είναι ένα από τα πιο προχωρημένα Multi-Agent συστήματα σήμερα. Παρατηρήστε τη διάρθρωση εργασιών: ο WebSurfer σερφάρει το web, ο FileSurfer διαβάζει αρχεία, ο Coder γράφει κώδικα, ο ComputerTerminal τα εκτελεί. Ο Orchestrator είναι ο «διευθυντής ορχήστρας» που βλέπει τη μεγάλη εικόνα και αποφασίζει ποιον θα δράσει επόμενο. Αυτό είναι ακριβώς το μοντέλο Contract Net ταυ Smith (1980) σε σύγχρονη εφαρμογή!
-->
...
<!--
Το Task Ledger είναι τα Beliefs του BDI: «τι ξέρω για τον κόσμο τώρα». Το Progress Ledger είναι τα Intentions: «σε τι δεσμεύτηκα να κάνω επόμενο». Το Stall Detection είναι ακριβώς ο μηχανισμός επανεξέτασης προθέσεων του BDI: αν η πρόθεση δεν προχωρά, επαναβαθμολογούμε (το παράδειγμα του τολμηρού vs προσεκτικού πράκτορα). Αυτή η διαφάνεια αποδεικνύει ότι η θεωρία του 1987 είναι πιο επίκαιρη από ποτέ!
-->
...
<!--
Ο Andrew Ng περιγράφει τα τέσσερα μοτίβα ως τα θεμέλια της agentic AI. Το Reflection είναι η AI εκδοχή του μηχανισμού σελφ-αξιολόγησης: γράψε, ελέγξε, βελτίωσε. Το Planning είναι η AI εκδοχή των Intentions του BDI: σπάσε το πρόβλημα σε βήματα πριν δράσεις. Ο Router είναι σαν ένας εξυπνος Manager στο CNP: βλέπει το αίτημα και το στέλνει στον ιδανικό agent. Το Swarm είναι σαν νοημοσύνη σμήνους για LLMs: κανείς δεν ελέγχει, οι agents αποφασίζουν μόνοι τους το ποιος είναι καλύτερα εξοπλισμένος για την επόμενη εργασία.
-->
...
<!--
Το GraphRAG είναι ένα από τα σημαντικότερα ανοιχτά φροντίδα στη RAG. Σκεφτείτε τη διαφορά: στο παραδοσιακό RAG, ψάχνουμε παρόμοια εγγραφεία («βρες μου το πιο αντίστοιχο κείμενο»). Στο GraphRAG, ψάχνουμε σχέσεις («βρες μου όσα συνδέονται μεταξύ τους»). Για ερωτήσεις όπως «ποιες εταιρείες γνωρίζονται με την Microsoft;» ή «σημαντικά γεγονότα από πολλαπλές πηγές;», ο γράφος είναι απαραίτητος.
-->
...
<!--
Οι τέσσερις μηχανισμοί επίλυσης αντιστοιχούν στα τέσσερα επίπεδα συστήματος. Ή ψηφοφορία: «οι περισσότεροι αποφασίζουν». Η MCDA/AHP: «βάλε αριθμούς και δες τι βγαίνει». Η Argumentation: «επιχειρηματολογήσου γιατί». Η Consensus Building: «βρες μεσαία λύση». Στα σύγχρονα Multi-Agent AI συστήματα, χρησιμοποιούνται οι ίδιες αρχές: κάποια συστήματα χρησιμοποιούν εκλογή Orchestrator (majority vote ανάμεσα σε multiple LLM calls) ή Argumentation (ο ένας agent αμφισβητεί τον άλλο, critic style).
-->
...
<!--
Η διαφάνεια αυτή είναι χρήσιμη καταρχήν. Παρατηρήστε την συνέχεια: από JADE (Java, 2000s) σε NetLogo (εκπαιδευτικό) σε LangGraph (LLM-based). Οι εργαλείο άλλαξαν, αλλά η ιδέα των αυτόνομων εξειδικευμένων πρακτόρων που συνεργάζονται παραμένει. Αν θέλετε να εργαστείτε σήμερα με AI Agents, η σύσταση είναι: LangGraph ή CrewAI για την αρχιτεκτονική, Mesa ή AgentPy αν θέλετε να μελετήσετε την αναδυόμενη συμπεριφορά.
-->
...
<!--
Η διαφάνεια αυτή είναι λίγο ιστορική: δείχνει πόσο ενθουσιάστηκε η επιχείρηση για τους εμπορικούς πράκτορες τη δεκαετία του ‘990, αλλά χωρίς την υποδομή του Internet και της υπολογιστικής ισχύος σήμερα. Ο Clippy της Microsoft ήταν ουσιαστικά ένας πράκτορας διεπαφής πρωτοπόρου γενιάς — απλώς είχε κακή UX και αποσύρθηκε. Ο απόγονος του με LLM είναι σήμερα το ChatGPT — με πολύ καλύτερη UX!
-->
...
<!--
Κλείνουμε με το μεγαλύτερο μήνυμα αυτής της ενότητας: η θεωρία των Ευφυών Πρακτόρων δεν είναι ξεπερασμένη — είναι εντελώς επίκαιρη. Από τον Ορισμό του Russell & Norvig (1995) μέχρι τους αυτόνομους AI Agents του 2024, η βασική αρχή δεν άλλαξε: ένας πράκτορας αντιλαμβάνεται, σκέφτεται και δρα. Το μόνο που άλλαξε είναι η υπολογιστική ισχύς και η ποιότητα του «εγκεφάλου» του.

Η κύρια γέφυρα: BDI ≈ RAG + System Prompt + Chain-of-Thought + Tool Calls. Contract Net ≈ Orchestrator + Subagents. GDSS ≈ AI-facilitated meetings με LLMs. Τα θεμέλια ήταν εδώ από δεκαετίες — σήμερα απλώς τα «ζωντανεύουμε» με LLMs!

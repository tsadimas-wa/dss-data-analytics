...
- **Σκοπός:** Να εισάγει τυχαίες, μικρές αλλαγές στα χρωμοσώματα, αποτρέποντας την πρόωρη σύγκλιση σε τοπικά βέλτιστα.
 - **Μέθοδοι:** Η μετάλλαξη εφαρμόζεται με βάση την **πιθανότητα μετάλλαξης (mutation probability)**.
...
![](../img/lec8/roulette_selection.svg)
...
> **Πίεση Επιλογής:** Ενώ το $x=24$ είναι ~διπλάσιο του $x=13$, η καταλληλότητά του είναι **3,4× μεγαλύτερη** ($576/169 \approx 3{,}41$) — η ρουλέτα "πριμοδοτεί" δυσανάλογα τις καλύτερες λύσεις.

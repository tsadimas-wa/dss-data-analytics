...
**Αριστερά:** Αναρρίχηση Λόφου — ξεκινά από ένα σημείο, ανεβαίνει τον κοντινότερο λόφο και **παγιδεύεται** στο τοπικό βέλτιστο (✗). Το ολικό βέλτιστο (★) παραμένει αναπάντητο.
**Δεξιά:** GA — πολλοί πράκτορες εξερευνούν παράλληλα · **crossover** γεννά απόγονο ανάμεσα σε δύο γονείς · **mutation** πηδά τυχαία σε νέα περιοχή. Αποτέλεσμα: εύρεση ολικού βελτίστου.

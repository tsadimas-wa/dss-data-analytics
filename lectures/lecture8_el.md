...
**Αριστερά — Αναρρίχηση Λόφου:** ξεκινώντας από ένα σημείο, ανεβαίνουμε πάντα προς το τοπικά καλύτερο γείτονα. Αν βρεθούμε στον λάθος λόφο, **παγιδευόμαστε** στο τοπικό βέλτιστο.
**Δεξιά — Γενετικός Αλγόριθμος:** πετάμε **πολλούς πράκτορες** σε διαφορετικά σημεία. Το **crossover** γεννά απόγονο μεταξύ δύο γονέων · η **μετάλλαξη** πηδά τυχαία σε νέα περιοχή. Έτσι ο GA εξερευνά παράλληλα ολόκληρο τον χώρο.
